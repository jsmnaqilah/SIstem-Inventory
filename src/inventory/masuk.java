...
public class masuk extends javax.swing.JFrame {
    ...
    protected void datatable() {
        Object[] Baris={"ID MASUK","KODE BARANG","NAMA BARANG","TANGGAL MASUK",
            "JUMLAH MASUK","ID STAFF","ID SUPPLIER"};
        tabmode = new DefaultTableModel(null,Baris);
        tableMasuk.setModel(tabmode);
        ...
        try{
            ...
            while(hasil.next()){
                String a = hasil.getString("idMasuk");
                String b = hasil.getString("kode");
                String c = hasil.getString("namaBrg");
                String d = hasil.getString("tglMasuk");
                String e = hasil.getString("jumlahMasuk");
                String f = hasil.getString("idStaff");
                String g = hasil.getString("idSupplier");
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(50, 230, 810, 310);
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/9HAL MASUK.png"))); // NOI18N
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        // TODO add your handling code here:
        try {
            String path="./src/laporan/lapMasuk.jasper";
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        tabmode = new DefaultTableModel(null,Baris);
        tableMasuk.setModel(tabmode);
        String sql="SELECT * FROM masuk WHERE idMasuk LIKE '%"+tSearch.getText()+"%'";
