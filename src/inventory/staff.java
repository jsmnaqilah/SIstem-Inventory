...
public class staff extends javax.swing.JFrame {
    ...
    protected void datatable() {
        Object[] Baris={"ID STAFF","NIK","NAMA","NO HP","TTL","ALAMAT"};
        ...
        try{
            ...
            while(hasil.next()){
                String a = hasil.getString("idStaff");
    ...
    private void initComponents() {
        ...
        tableStaff.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID STAFF", "NIK", "NAMA", "NO HP", "TTL", "ALAMAT"
            }
        ));
        ...
        jScrollPane1.setBounds(60, 230, 780, 300);
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/4HAL STAFF.png"))); // NOI18N
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        // TODO add your handling code here:
       try {
            String path="./src/laporan/lapStaff.jasper";
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        tabmode = new DefaultTableModel(null,Baris);
        tableStaff.setModel(tabmode);
        String sql="SELECT * FROM Staff WHERE idStaff LIKE '%"+tSearch.getText()+"%'";
